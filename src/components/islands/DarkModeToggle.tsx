...
export default function DarkModeToggle() {
  ...
  return (
    ...
    >
      ...
      <svg class={styles['icon-sun']} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <svg class={styles['icon-moon']} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
